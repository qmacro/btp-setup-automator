...
async function getContent() {
    ...
    const sourcePath = process.env["DOCUMENTATION_SOURCE_PATH"];
    const targetPath = process.env["DOCUMENTATION_TARGET_PATH"];
...
async function getContentFromGitHub(sourcePath) {
    ...
    const pat = process.env["DOCUMENTATION_READ_TOKEN"];
    const owner = process.env["DOCUMENTATION_SOURCE_OWNER"];
    const repo = process.env["DOCUMENTATION_SOURCE_REPO"];
